...
/** @type {string} */
const CACHE_VERSION = '1789805808|1872773';
/** @type {string} */
...
/** @type {string[]} */
const CACHED_FILES = ["index.html", "index.js", "index.offline.html", "index.icon.png", "index.apple-touch-icon.png", "index.audio.worklet.js", "index.audio.position.worklet.js", "index.144x144.png", "index.180x180.png", "index.512x512.png", "index.manifest.json", "index.png"];
